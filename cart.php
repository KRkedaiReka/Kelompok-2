            		...
            		?>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="<?php echo $row['gambar_produk']; ?>" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black"><?php echo $row['nama_produk']; ?></h2>
                          </td>
                          <td>Rp. <?php echo $row['harga_produk']; ?></td>
                          <td><?php echo $row['jumlah_produk']; ?></td>
                          <td>Rp. <?php echo $row['total']; ?></td>
                          <td><a href="cart_delete.php?id_keranjang=<?php echo $row['id_keranjang']; ?>" class="btn btn-black btn-sm">X</a></td>
                        </tr>
                        <?php 
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row mb-5">
                        ...
                        <div class="col-md-6 text-right">
                          <strong class="text-black">Rp. <?php echo $total_harga;?></strong>
                        </div>
                      </div>
