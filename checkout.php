...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Checkout wkwk.store</title>
	</head>
		                ...
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    ...
		                    <tr>
		                      ...
		                      <td class="text-black font-weight-bold"><strong>115.000</strong></td>
		                    </tr>
		                  </tbody>
		                </table>
		            ...
		            <div class="form-group row">
		              ...
		              <div>
		                ...
		                <div class="form-group mt-5">
		                  <button class="btn btn-black btn-lg py-3 btn-block" onclick="window.location='thankyou.php'">Order</button>
		                </div>
